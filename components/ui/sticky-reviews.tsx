...
const cardVariants = cva('absolute will-change-transform', {
  variants: {
    variant: {
      dark: 'flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-stone-700/50 bg-zinc-900/80 p-6 backdrop-blur-md text-white',
      light:
        'flex size-full flex-col items-center justify-center gap-6 rounded-2xl border border-zinc-200 bg-white/80 p-6 backdrop-blur-md text-zinc-900',
    },
  },
...
> = ({ children, className, ...props }) => {
  return (
    <div
      className={cn(
        'relative flex h-[30rem] w-full items-center justify-center',
        className,
      )}
